...
#if (BOARD_TYPE == BOARD_TYPE_VPU7702) || \
    (BOARD_TYPE == BOARD_TYPE_EBC7702_EVB) || \
    (BOARD_TYPE == BOARD_TYPE_VPU7702_PCIE) || \
    (BOARD_TYPE == BOARD_TYPE_EBC7702_P01_D560) || \
    (BOARD_TYPE == BOARD_TYPE_EBC7702_P01_PCIE) || \
    (BOARD_TYPE == BOARD_TYPE_M2_EVB) || \
    (BOARD_TYPE == BOARD_TYPE_M2_PCIE) || \
    (BOARD_TYPE == BOARD_TYPE_U2_EVB) || \
    (BOARD_TYPE == BOARD_TYPE_U2_PICE)
