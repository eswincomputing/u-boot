...
#define CFG_EXTRA_ENV_SETTINGS \
    ...
    "uuid_rootfs=80a5a8e9-c744-491a-93c1-4f4194fd690a\0" \
    ...
    "partitions=name=boot,start=1MiB,size=500MiB,type=${typeid_filesystem};name=swap,size=4096MiB,type=${typeid_swap},uuid=${uuid_swap};name=root,size=-,type=${typeid_filesystem},uuid=${uuid_rootfs}\0" \
